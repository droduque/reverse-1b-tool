...
def write_cell(sheet_root, cell_ref, value, shared_strings, log_entries, description=""):
    """
    ...
    - SKIPS cells that contain formulas (has <f> element)
    """
    ...
    # Check for formula — never overwrite formula cells
